  ...
  return (
    <div>
      ...
      <div className="parallax">
       ...
       <img src="design assets fulsltack/black.jpg"
         style={{
         zIndex: 0,
         width: '100vw', 
         height: '100vh', 
      ...
      <div className="cards-section">
        <div className="min-h-screen bg-gradient-to-b from-black via-blue-950 to-blue-700 text-white p-6">
          ...
          />
            ...
            <p className="text-lg md:text-xl mt-4"  style={{
             fontFamily: 'Aboreto',}}>Your gateway to study materials and activities</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 px-6">
            ...
            <Link to="/previous" className="group">
              <div className="bg-gradient-to-r from-amber-200 to-orange-900 p-8 mb-10 rounded-lg shadow-xl transform hover:scale-105 text-white transition-all duration-300 ease-in-out">
                <h2 className="text-2xl font-bold text-center">Previous Year Question</h2>
      ...
      <div className="footer bg-blue-700 h-screen p-6">
        ...
        <p className="text-sm">
         <a href="https://www.instagram.com/shubh_.xyz?igsh=emUxY2dza21lamt1 " target="_blank" rel="noopener noreferrer">
          <i className="fab fa-instagram " ></i>  <img src="design assets fulsltack/inst.png" alt="Instagram" style={{ width: '40px', height: '40px', marginLeft: '5px' }} />
         </a>
         <br />
         <a href="https://www.linkedin.com/in/shubh-gupta-27918428a?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app
          " target="_blank" rel="noopener noreferrer">
          <i className="fab fa-linkedin " ></i> <img src="design assets fulsltack/lin.png" alt="linkedin" style={{ width: '37px', height: '37px', marginLeft: '60px',marginTop:'-60px'}} />
         </a>
        </p>
        </div>
        <div className="w-1/3 md:w-1/3 xl:w-1/3 p-4">
        ...
        <p className="text-sm">
          <a href="https://www.instagram.com/_kart1k_?igsh=MTU5c3ByNzViajJrYw==" target="_blank" rel="noopener noreferrer">
           <i className="fab fa-instagram"></i>  <img src="design assets fulsltack/inst.png" alt="Instagram id- _kart1k_" style={{ width: '40px', height: '40px', marginLeft: '5px' }} />
          </a>
          <br />
          <a href="https://www.linkedin.com/in/kartik-gupta-038473322" target="_blank" rel="noopener noreferrer">
           <i className="fab fa-linkedin"></i>  <img src="design assets fulsltack/lin.png" alt="linkedin" style={{ width: '37px', height: '37px', marginLeft: '60px',marginTop:'-60px'}} />
          </a>
        </p>
        </div>
        ...
        <p className="text-sm">
         <a href="https://www.instagram.com/vaibhavkothari_33?igsh=MTA4bG9lYW43M214cg==" target="_blank" rel="noopener noreferrer">
          <i className="fab fa-instagram"></i>  <img src="design assets fulsltack/inst.png" alt="Instagram" style={{ width: '40px', height: '40px', marginLeft: '5px' }} />
         </a>
         <br />
         <a href="https://www.linkedin.com/in/vaibhavkothari33/" target="_blank" rel="noopener noreferrer">
          <i className="fab fa-linkedin"></i> <img src="design assets fulsltack/lin.png" alt="linkedin" style={{ width: '37px', height: '37px', marginLeft: '60px',marginTop:'-60px'}} />
         </a>
        </p>
        </div>
...
const Home = () => {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-black via-blue-900 to-orange-900 text-white">
      ...
      <div className="text-center mb-12">
        <h1 className="text-4xl md:text-6xl font-bold mt-10 tracking-wider">First Year Resource Hub</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 px-6">
        ...
        <Link to="/semester2" className="group">
          <div className="bg-gradient-to-r from-blue-600 to-cyan-500 p-8 rounded-lg shadow-xl  transform hover:scale-105  text-white transition-all duration-300 ease-in-out">
            <h2 className="text-2xl font-bold text-center">Semester 2</h2>
            <p className="mt-4 text-center">Find all resources for Semester 2 here.</p>
          </div>
        </Link>
        ...
        <Link to="/extracurricular" className="group">
          <div className="bg-gradient-to-r from-indigo-600 to-purple-600 p-8 rounded-lg shadow-xl  transform hover:scale-105  text-white transition-all duration-300 ease-in-out">
            <h2 className="text-2xl font-bold text-center">Extracurricular</h2>
            <p className="mt-4 text-center">Explore extracurricular activities here.</p>
          </div>
        </Link>
      {/* Hidden box might add some thing if needed */}
      

        <Link to="/previous" className="group">
          <div className="bg-gradient-to-r from-blue-600 to-cyan-500 p-8 mb-10 rounded-lg shadow-xl  transform hover:scale-105  text-white transition-all duration-300 ease-in-out">
            <h2 className="text-2xl font-bold text-center">Previous Year Question</h2>
            <p className="mt-4 text-center">Previous Year papers</p>
          </div>
        </Link>
