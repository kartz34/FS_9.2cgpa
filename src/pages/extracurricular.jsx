  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black via-gray-900 to-purple-900 text-white p-6">
      ...
      <div className="mb-6 flex justify-between">
        <button
          onClick={() => navigate(-1)}
          className="ml-4 mt-4 px-4 py-2 bg-purple-500 text-white rounded-md hover:bg-purple-600 focus:outline-none focus:ring-2 focus:ring-purple-600"
        >
          Back
        </button>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        {extraCurricularSkills.map((subject) => (
          ...
          >
            <h2 className="text-xl font-bold text-center text-purple-300">
              {subject.title}
            </h2>
          </div>
        ))}
